...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/inbox/:path*", destination: "/achats/:path*", permanent: false },
      { source: "/boite-de-reception/:path*", destination: "/achats/:path*", permanent: false },
      ...
      { source: "/comptable-pro/dossiers/:id/inbox/:path*", destination: "/comptable-pro/dossiers/:id/achats/:path*", permanent: false },
      { source: "/comptable-pro/dossiers/:id/boite-de-reception/:path*", destination: "/comptable-pro/dossiers/:id/achats/:path*", permanent: false },
  ...
  async rewrites() {
    return [
      ...
      { source: "/achats", destination: "/inbox" },
      ...
      { source: "/comptable-pro/dossiers/:id/achats", destination: "/comptable-pro/dossiers/:id/inbox" },
