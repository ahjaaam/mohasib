...
const comparisons = [
  ...
  { topic: "Transactions bancaires", without: "Télécharger les relevés et reclasser chaque mouvement à la main.", alternative: "Le relevé et le tableau de suivi restent dans des outils séparés.", mohasib: "Les mouvements sont importés et organisés dans un espace unique." },
