...
const comparisons = [
  ...
  { topic: "Rapprochement bancaire", without: "Comparer les transactions et notes de frais ligne par ligne.", alternative: "Relevé bancaire et tableau de suivi doivent être recoupés.", mohasib: "Les correspondances sont suggérées; vous traitez seulement les exceptions." },
