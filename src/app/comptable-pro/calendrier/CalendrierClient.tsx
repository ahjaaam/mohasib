        ...
        <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
              ...
              {dayEvents.map(ev => (
                <div key={ev.id} className="flex items-start gap-3 p-3 rounded-xl border border-[rgba(0,0,0,0.07)]">
                  ...
                  {"fiscal" in ev && ev.fiscal ? (
                    <span className="text-[9.5px] font-semibold px-2 py-0.5 rounded flex-shrink-0"
          ...
          {showForm && (
            <div className="space-y-3 pt-1">
              ...
              {dossiers.length > 0 && (
                <div>
                  <label className="label">Dossier client (optionnel)</label>
    ...
    <div>
      ...
      <div className="flex items-center gap-2.5 mb-5">
        <div className="w-9 h-9 rounded-xl bg-[rgba(200,146,74,0.12)] flex items-center justify-center flex-shrink-0">
          <Calendar size={18} className="text-[#C8924A]" />
        </div>
        <div>
          <h1 className="text-[18px] font-bold text-[#1A1A2E] leading-none">Calendrier comptable</h1>
          <p className="text-[11px] text-[#9CA3AF] mt-0.5">Échéances fiscales et sociales — Maroc</p>
        </div>
      </div>
      ...
      {/* ── Calendar grid ───────────────────────────────────────────────────── */}
      <div className="bg-white border border-[rgba(0,0,0,0.08)] rounded-xl overflow-hidden flex-1"
