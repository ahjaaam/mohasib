    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-2.5 mb-5">
        <div className="w-9 h-9 bg-[rgba(200,146,74,0.12)] flex items-center justify-center flex-shrink-0">
          <FolderPlus size={18} className="text-[#C8924A]" />
        </div>
        <div>
          <h1 className="text-[18px] font-bold text-[#1A1A2E] leading-none">Nouveau dossier</h1>
          <p className="text-[11px] text-[#9CA3AF] mt-0.5">Créez un dossier pour un client</p>
        </div>
      </div>
