...
export default async function NewAvoirClientPage() {
  ...
  return (
    <>
      <PageHeader title="Nouvel avoir client" subtitle="Émettre un avoir sur facture client" icon={<BackIconLink href="/factures?mode=avoirs" label="Retour aux avoirs" />} iconBare />
      <NewAvoirForm
        clients={clients}
