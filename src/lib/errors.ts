...
const MESSAGE_MAP: [string, string][] = [
  ...
  ["trial_limit_reached:documents", "L'essai gratuit permet d'archiver 10 documents. Passez à un plan payant pour continuer."],
  ...
  ["trial_limit_reached:tva_declarations", "L'essai gratuit permet de valider 1 déclaration TVA. Passez à un plan payant pour continuer."],
  ["trial_limit_reached:clients", "L'essai gratuit permet de créer 5 clients. Passez à un plan payant pour gérer toute votre base clients."],
  ["trial_limit_reached:transactions", "L'essai gratuit permet de créer 20 transactions. Passez à un plan payant pour continuer votre saisie."],
  ["trial_limit_reached:accounting_entries", "L'essai gratuit permet de créer 20 écritures comptables. Passez à un plan payant pour continuer la saisie."],
