export const FEATURES = {
  ...
  // Rapprochement is intentionally unavailable until it is ready to be shared again.
  RAPPROCHEMENT_ENABLED: process.env.NEXT_PUBLIC_RAPPROCHEMENT_ENABLED === "true",
