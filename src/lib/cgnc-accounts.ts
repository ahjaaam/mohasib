...
export const cgncAccounts: CgncAccount[] = [
  ...
  { code: "6129", label: "RRR obtenus sur achats consommés" },
  ...
  { code: "6149", label: "RRR obtenus sur autres charges externes" },
  { code: "6153", label: "Formation du personnel" },
  ...
  { code: "6386", label: "Escomptes accordés" },

  // Classe 7 — Produits
  { code: "7111", label: "Ventes de marchandises" },
  { code: "7119", label: "RRR accordés sur ventes de marchandises" },
  { code: "7121", label: "Ventes de biens produits" },
  { code: "7129", label: "RRR accordés sur ventes de biens et services produits" },
  ...
  { code: "7382", label: "Produits des immeubles" },
  { code: "7386", label: "Escomptes obtenus" },
...
export const categoryToCompte: Record<string, string> = {
  ...DEFAULT_REVENUE_CATEGORY_ACCOUNTS,
