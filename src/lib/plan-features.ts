...
export const DEFAULT_PLAN_LIMITS: Record<string, Record<string, number | boolean>> = {
  trial:         { ocr_limit: 50,  storage_gb: 5,   dossiers_limit: 0,  users_limit: 1, employee_limit: 0,  has_bank_import: false, has_saisie: false, has_paie: false, has_export_fiduciaire: false, has_avoirs: false, has_bilan: false, has_tva_edi: false, has_inbox_global: false, has_mass_declarations: false },
