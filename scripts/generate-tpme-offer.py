...
def draw_pdf() -> None:
    ...
    before = [
        ...
        "Justificatifs dispersés entre email et WhatsApp",
...
<div class="compare"><article class="box before"><h3>SANS MOHASIB</h3><ul><li>Devis et factures dans plusieurs outils</li><li>Paiements suivis tardivement</li><li>Justificatifs dispersés entre email et WhatsApp</li><li>TVA préparée dans l'urgence</li><li>Échanges répétés avec le comptable</li></ul></article><article class="box after"><h3>AVEC MOHASIB</h3><ul><li>Du devis à la facture, puis à l'encaissement</li><li>Trésorerie, échéances et impayés visibles</li><li>Pièces reçues, lues, classées et retrouvées</li><li>TVA et écritures préparées en continu</li><li>Votre comptable accède au dossier organisé</li></ul></article></div>
